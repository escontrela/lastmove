...
public final class LichessArenaService {
  ...
  public LichessArenaService(LichessArenaRepository arena,KnightshadeArenaSettingsRepository settings,LichessBotClient client,ApplicationEventPublisher events){this.arena=Objects.requireNonNull(arena);this.settings=Objects.requireNonNull(settings);this.client=Objects.requireNonNull(client);this.events=Objects.requireNonNull(events);}
