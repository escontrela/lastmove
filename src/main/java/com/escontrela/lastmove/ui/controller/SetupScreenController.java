...
public class SetupScreenController implements UiScreenController {
    ...
    private void configureBloodPressureTelemetry() {
        ...
        for (String metric : List.of("depth", "mainNodes", "qNodes", "TT hit / cutoff", "beta cutoff", "PVS re-search", "null / LMR", "aspiration retries", "evaluation cache", "workers", "stopReason", "stop counters")) {
