...
public final class PositionEditorScreenController implements UiScreenController {
  ...
  public PositionEditorScreenController(PositionEditorService editor, AnalysisSessionService analysisSessions,
      CurrentUserService currentUserService, ClipboardService clipboard, UiEventBus events, @Lazy UiFlowManager flow) {
    this.editor = editor; this.analysisSessions = analysisSessions; this.currentUserService = currentUserService;
