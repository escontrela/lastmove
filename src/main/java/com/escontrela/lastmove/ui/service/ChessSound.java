...
public enum ChessSound {
  MOVE_SELF("/chess-sounds/move-self.wav"),
  CAPTURE("/chess-sounds/capture.wav"),
  PROMOTE("/chess-sounds/promote.wav"),
  CASTLE("/chess-sounds/castle.wav"),
  MOVE_CHECK("/chess-sounds/move-check.wav"),
  NOTIFY("/chess-sounds/notify.wav"),
