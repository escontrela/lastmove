...
- Pendientes: libro de aperturas, tablebases, bitboards y estudio de una TT compartida. La búsqueda de variantes raíz ya es paralela, con tableros, heurísticas y TT privados por trabajador.
